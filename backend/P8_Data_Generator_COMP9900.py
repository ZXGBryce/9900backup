...
def generate_esg_frameworks():
    ...
    TNFD_INDICATORS = {"Proportion of annual revenue exposed to physical risks": "G",
                       "Total annual revenue exposed to physical risks": "G",
                       "Proportion of annual revenue exposed to transition risks": "SG",
                       "Total annual revenue exposed to transition risks": "SG",
    ...
    IFRS_INDICATORS = {"Amount of assets vulnerable to transition risks":"G",
                       "Percentage of assets vulnerable to transition risks":"G",
                       "Amount of business activities vulnerable to transition risks":"G",
                       "Percentage of business activities vulnerable to transition risks":"G",
                       "Amount of assets vulnerable to physical risks":"EG",
                       "Percentage of assets vulnerable to physical risks":"EG",
                       "Amount of business activities vulnerable to physical risks":"EG",
                       "Percentage of business activities vulnerable to physical risks":"EG"
                       }
